...
class InterfaceView():
    def __init__(self):
        ...
        self.search=ttk.Entry(self.f0, textvariable=stfv, width=23)
        self.search.pack(padx=(0,13))
        self.scrollbarAll = ttk.Scrollbar(self.f0)
        self.scrollbarAll.pack(side=RIGHT, fill=Y)
        self.vAll = Variable()
        self.lAll = Listbox(self.f0, height=5, width=23, yscrollcommand=self.scrollbarAll.set, listvariable=self.vAll)
        self.lAll.pack()
        ...
        self.ltargets = Listbox(self.f1, height=6, width=23, yscrollcommand=self.scrollbarTargets.set, listvariable=self.vtargets)
        self.ltargets.pack()
