...
## Instalation
Install the libraries: Pandas, Numpy, MatPlotLib, BeautifulSoup and Numba.
Run DbCreate.py #download the PWMs from YeTFaSCo and TF information from yeastgenome.org to create the database
